...
const CREATE_INPUT = {
  ...
  userCompanyName: "exampleUserCompanyName",
  userJobTitle: "exampleUserJobTitle",
};
const CREATE_RESULT = {
  id: "exampleId",
  createdAt: new Date(),
  ...
  test("POST /users", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        userDateOfBirth: CREATE_RESULT.userDateOfBirth.toISOString(),
      });
  });
      ...
      .expect([
        {
          ...
          userDateOfBirth: FIND_MANY_RESULT[0].userDateOfBirth.toISOString(),
        },
      ]);
  });
  ...
  test("GET /users/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        userDateOfBirth: FIND_ONE_RESULT.userDateOfBirth.toISOString(),
      });
  });
